...
import java.net.URL;
public class TestLoginErrorCorreoTest {
  ...
  @Test
  public void testLoginErrorCorreo() {
	  try {
		  driver.get("http://node-teamada.northeurope.cloudapp.azure.com:1337/login");
		  Thread.sleep(1000);
		    driver.findElement(By.cssSelector(".form-group:nth-child(1) > .form-control")).sendKeys("prueba1@node.com");
		    Thread.sleep(1000);
