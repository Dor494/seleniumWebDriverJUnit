...
import java.net.URL;
public class TestregistrofallidopasswordTest {
  ...
  @Test
  public void testregistrofallidopassword() {
	  try {
	        ...
	        Thread.sleep(1000);
	        assertThat(driver.findElement(By.cssSelector(".invalid-feedback")).getText(), is("Please enter a password."));
